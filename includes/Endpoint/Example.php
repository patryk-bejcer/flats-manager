...
class Example
{
    ...
    {
        $example_option = get_option('RP_example_setting');
    ...
    {
        $updated = update_option('RP_example_setting', $request->get_param('exampleSetting'));
    ...
    {
        $deleted = delete_option('RP_example_setting');
